...
const Websites = () => {
    return (
        <div>
            ...
            <a href="/">
            <motion.div className="banner" transition={{duration: 1}} animate={{ opacity:1, y:0 }} initial={{ opacity:0, y:-100}} whileHover={{scale: 1.1}}>
        ...
        <div className="space"></div>
            ...
            <div className="padd-left-twenty">
                ...
                <motion.div whileHover={{scale: 1.1}}  class="imgcontainer">
